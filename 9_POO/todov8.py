...
class Projeto:
    ...
    def _add_nova_tarefa(self, descricao, **kwargs):
        self.tarefas.append(Tarefa(descricao, kwargs.get('vencimanto', None)))
...
def main():
    ...
    mercado.add('Carne')
    mercado.add('Tomate', datetime.now() + timedelta(days=2, minutes=12))
    print(mercado)

    for tarea in mercado:
        print(f'- {tarea}')
